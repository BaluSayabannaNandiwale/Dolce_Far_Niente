...
urlpatterns = [
    ...
    path('add_question/<str:test_id>/', views.add_objective_question_view, name='add_objective_question'),
    path('add_questionLQA/<str:test_id>/', views.add_long_question_view, name='add_long_question'),
    path('add_questionPQA/<str:test_id>/', views.add_practical_question_view, name='add_practical_question'),
